...
function addPosition(_position){
  ...
  tr += '</td>';
  tr += '<td>';
  tr += '<div class="input-group"><textarea class="positionAttr form-control" data-concat="1" data-l1key="position::allowmove" style="height:75px"></textarea><span class="input-group-addon hasBtn roundedRight"><a class="btn btn-default listCmdInfoPos" ><i class="fas fa-list-alt"></i></a></span></div>';
  tr += '</td>';
  tr += '<td>';
...
function addConditions(_condition){
  ...
  tr += '</td>';
  tr += '<td>';
  tr += '<div class="input-group"><textarea class="conditionsAttr form-control" data-concat="1" data-l1key="conditions::condition" style="height:75px"></textarea><span class="input-group-addon hasBtn roundedRight"><a class="btn btn-default listCmdInfoConditions" ><i class="fas fa-list-alt"></i></a></span></div>';
  tr += '</td>';
  tr += '<td>';
